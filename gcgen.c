...
static const uint8_t htc_xor[] = {
	0x27, 0xBC, 0x9A, 0xD5, 0x0A, 0x93, 0x6D, 0x02,
	0x2C, 0x61, 0x0E, 0x6E, 0xBA, 0x51, 0x09, 0x99,
	0x29, 0x57, 0xDE, 0x54, 0x94, 0x2B, 0x6F, 0x2A,
	0x35, 0xA5, 0x63, 0x59, 0x12, 0x0B, 0x63, 0xE3,
	0xDB, 0x77, 0x6E, 0x3E, 0xA4, 0xB8, 0xDC, 0x79,
	0x1E, 0xE9, 0xD5, 0x80, 0xD6, 0xC9, 0xBB, 0xDB,
	0x93, 0x06, 0xD7, 0xCD, 0x49, 0x2D, 0xDA, 0x15,
...
int main(int argc, char* argv[])
{
	...
	// Store File Buffer
	fout = fopen("goldcard.img", "wb");
	if (fout == NULL) {
		printf("ERROR: Unable to open file \"goldcard.img\".\n");
		return -1;
	}
	for (i = 0; i < GCBUFSIZE; i++)
		fputc(goldcardbuf[i], fout);
	fclose(fout);
